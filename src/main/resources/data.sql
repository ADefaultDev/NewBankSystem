...
INSERT INTO credit_type (currency_id, max_amount, min_amount, name, rate, repayment_time) SELECT 1,555555,90, 'Date0Test',55,0 WHERE NOT EXISTS (SELECT * FROM credit_type WHERE name = 'Date0Test');
